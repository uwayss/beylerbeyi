...
export const exampleConfig: PageConfig = {
  sections: [
    ...
    },
    {
      ...
      body: "Sarayın denize açılan rıhtımı, misafirleri sandallarla karşılayarak daha ilk anda teatral bir etki yaratırdı. Zemin katın yazlık planı, serin kuzey rüzgârlarını içeri davet eder.",
      imageLayers: [
        {
    ...
    },
    {
      ...
      body: "Tavanlardaki altın varak süslemeler Roma atölyelerinde hazırlanırken duvar panellerindeki geometrik desenler Üsküdar’daki ahşap ustalarının imzasını taşıyor.",
      imageLayers: [
        {
    ...
    },
    {
      ...
      description:
        "Aşağıdaki istasyonlar sunum sırasında hikâyeyi 5 dakikaya yaymanız için hazırlandı. İstediğiniz kadar detay ekleyebilir ya da çıkarabilirsiniz.",
      entries: [
        {
          year: "1829",
          title: "İlk Beylerbeyi Kasrı",
          description:
            "Sultan II. Mahmud döneminde aynı bölgede ahşap köşk inşa edildi.",
        },
        {
          year: "1851",
          title: "Yangın",
          description:
            "Kasır büyük bir yangında kül oldu; bölge uzun süre boş kaldı.",
        },
        {
          year: "1864",
          title: "Yeni Sarayın Açılışı",
          description:
            "Sultan Abdülaziz, deniz kıyısındaki yeni sarayı büyük törenle açtı.",
        },
        {
          year: "1920’ler",
          title: "Cumhuriyet Yılları",
          description:
            "Saray, yabancı devlet adamları için konuk evi olarak kullanıldı.",
        },
      ],
    },
    {
  ...
  transcript: {
    title: "Örnek Transcript",
    subtitle: "Bu alan /transcript sayfası için zorunludur.",
    totalDuration: "05:00",
    speakers: [
      { id: "spk1", name: "Konuşmacı 1", color: "#f59e0b" },
      { id: "spk2", name: "Konuşmacı 2", color: "#38bdf8" },
    ],
    segments: [
      {
        speakerId: "spk1",
        section: "Giriş",
        duration: "02:00",
        text: "Örnek konuşma metni 1",
      },
      {
        speakerId: "spk2",
        section: "Kapanış",
        duration: "03:00",
        text: "Örnek konuşma metni 2",
      },
    ],
  },
};
